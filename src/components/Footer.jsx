...
const Footer = () => {
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-pink-200 w-full overflow-hidden ' id="Footer">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
            ...
            <div className="w-full md:w-1/5 mb-8 md:mb-0">
                ...
                <ul className="flex flex-col gap-2 text-red-600">
            ...
            <div className="w-full md:w-1/3">
               ...
               <div className="flex gap-2">
                <input type="email" name="Email" placeholder="Enter your email" className="p-2 rounded bg-gray-300 text-blue-400 border border-purple-300 focus:outline-none w-full md:w-auto" />
                <button className='py-2 px-4 rounded bg-red-700 text-white'>Subscribe</button>
               </div>
